...
<head>
  ...
  <link href="img/logoo.jpeg" rel="icon">
                  ...
                  <form method="post">
                   <div class="form-group row mb-3">
                     ...
                     <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" required placeholder="xxxx-ag-xxxx" name="admissionNumber" value="<?php echo $row['admissionNumber'];?>" id="exampleInputFirstName" >
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
